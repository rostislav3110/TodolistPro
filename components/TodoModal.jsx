  ...
  renderTodo = ({ item }, index) => {
    return (
      <View style={styles.todoContainer}>
        <TouchableOpacity onPress={() => this.toggleTodoCompleted(index)} style={{ flexDirection: 'row', alignItems: 'center' }}>
          <Ionicons
        ...
        <TouchableOpacity style={styles.deleteButton} onPress={() => this.deleteTodo(index)}>
          <Text style={{ color: Colors.red, fontSize: 16, fontWeight: '600' }}>Delete</Text>
        </TouchableOpacity>
      </View>
    );
  };
